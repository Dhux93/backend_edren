...
var UserController = /** @class */ (function () {
    ...
    UserController.getAll = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, userRepository.find({ select: ['id', 'Usuario', 'Role', 'Pais', 'Idioma', 'Email'] })];
                case 2:
                    users = _a.sent();
                    return [3 /*break*/, 4];
                case 3:
    ...
    UserController.new = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, usuario, password, role, pais, idioma, email, user, validationOpt, errors, token, userRepository, e_3;
    ...
    UserController.edit = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var user, id, _a, usuario, role, pais, idioma, email, userRepository, e_4, validationOpt, errors, e_5;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    id = req.params.id;
                    _a = req.body, usuario = _a.usuario, role = _a.role, pais = _a.pais, idioma = _a.idioma, email = _a.email;
                    userRepository = typeorm_1.getRepository(Users_1.Users);
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
